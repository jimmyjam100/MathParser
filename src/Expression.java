...
interface Expression {
	...
	Expression deepCopy ();
	/**
	 * replaces n1 anywhere in the expression tree with n2
	 * @param n1 the expression to be replaced
	 * @param n2 the expression to replace n1 wiht
	 */
	void replaceDeep(Expression n1, Expression n2);
	/**
